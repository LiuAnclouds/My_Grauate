...
from eda.data_loader import LABEL_NAMES, PhaseData, load_phase
...
def run_eda(phases: list[str], analyses: list[str], outdir: Path) -> dict[str, Any]:
    ...
    if "drift" in analyses and ACTIVE_DATASET_SPEC.split_style == "two_phase":
        ...
        dataset_summary["drift"] = {
            ...
            "drift_summary_path": "drift_summary.md",
        }
    ...
    write_json(outdir / "dataset_summary.json", dataset_summary)
