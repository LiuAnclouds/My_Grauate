...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=f"Run reproducible Analysis for the active dataset: {dataset_spec.display_name}."
    )
    parser.add_argument(
        "--phase",
...
def main() -> None:
    ...
    summary = run_analysis(phases=phases, analyses=list(args.analysis), outdir=args.outdir)
    print(f"Analysis finished. Overview written to: {args.outdir / 'analysis_overview.json'}")
