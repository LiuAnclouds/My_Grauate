...
class DygDataset(torch.utils.data.Dataset):
    def __init__(self, config, split_flag):
        ...
        (self.input_nodes_feature,
         self.input_edges_feature,
         self.input_edges_pad, self.labels,
         self.Tmats,
         self.adjs,
         self.eadjs,
         self.mask_edge) = self.get_data(data, split_flag)
    def get_data(self, data, split_flag):
        ...
        # print(f"Nfeatures:{Nfeatures.shape}\nEfeatures:{Efeatures.shape}")
        ...
        # print(f"mask_edge:{mask_edge}\ninput_edges_pad:{input_edges_pad}\ninput_Edges_feature:{input_edges_pad}")
