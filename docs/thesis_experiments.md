...
- [thesis_m8_utgt_teacher_hpsearch1_gnnprimary04999](../experiment/outputs/thesis_suite/thesis_m8_utgt_teacher_hpsearch1_gnnprimary04999/summary.json)
...
| Elliptic | 0.784234 | 0.968031 | 0.897653 | +0.113419 |
| Elliptic++ | 0.783733 | 0.963736 | 0.899186 | +0.115453 |
| Macro Val AUC | 0.786786 | 0.908965 | 0.864310 | +0.077524 |
...
- `teacher-guided` 后，pure GNN 宏平均从 `0.767140` 提升到 `0.786786`
- 再叠加 strict-frontier GNN-primary residual correction 后，宏平均提升到 `0.864310`
...
| Teacher-guided pure `m8_utgt` | 0.792391 | 0.784234 | 0.783733 | 0.786786 | 训练期 teacher guidance 有效 |
...
| Teacher `m8_utgt` + blend `0.4999` | 0.796091 | 0.897653 | 0.899186 | 0.864310 | 推荐主结果 |
| AUC-first blend `0.91` | 0.794897 | 0.965251 | 0.958475 | 0.906208 | appendix only，不作为论文主线 |

从这张表能直接读出的结论：

1. `teacher guidance` 相对纯 `m8_utgt` 带来 `0.019646` 的宏平均提升
2. 在 dataset-scoped hparams 下，strict-frontier `alpha=0.4999` 把推荐主线推进到 `0.864310`
