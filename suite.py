...
from datasets.core.registry import DATASET_ENV_VAR, get_dataset_spec
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Preset passed through to mainline.py. "
...
def _write_suite_summary(
    *,
    ...
    suite_dir = REPO_ROOT / "outputs" / "reports" / "suites" / suite_name
...
def main() -> None:
    ...
    if str(args.model) == OFFICIAL_BACKBONE_MODEL and str(args.preset) != OFFICIAL_BACKBONE_PRESET:
        raise ValueError(
            ...
            "Use `mainline.py` for ad hoc ablations."
        )
