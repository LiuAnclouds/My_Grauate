...
def build_graph_label_artifacts(
    *,
    ...
    if include_historical_background_negatives:
        ...
        background_mask = (first_active <= int(threshold_day)) & np.isin(phase1_y, (2, 3))
    ...
    if known_label_feature:
        ...
        phase1_known_label_codes[phase1_y == 2] = 2
        phase1_known_label_codes[phase1_y == 3] = 3
        phase2_known_label_codes[phase2_y == 2] = 2
        phase2_known_label_codes[phase2_y == 3] = 3
