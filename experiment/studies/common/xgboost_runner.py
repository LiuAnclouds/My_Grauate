...
from experiment.features.features import FeatureStore, build_hybrid_feature_normalizer, resolve_feature_groups
...
def run_xgboost_dataset(
    *,
    ...
    from experiment.models.runtime import build_runtime  # local import to reuse correct label contract
